...
part of 'migration_database_v2.dart';
...
abstract class _$MigrationDatabaseV2 extends GeneratedDatabase {
  _$MigrationDatabaseV2(QueryExecutor e) : super(e);
  $MigrationDatabaseV2Manager get managers => $MigrationDatabaseV2Manager(this);
...
class $$MigrationRecordsTableFilterComposer
    extends Composer<_$MigrationDatabaseV2, $MigrationRecordsTable> {
...
class $$MigrationMetadataTableFilterComposer
    extends Composer<_$MigrationDatabaseV2, $MigrationMetadataTable> {
...
class $MigrationDatabaseV2Manager {
  final _$MigrationDatabaseV2 _db;
  $MigrationDatabaseV2Manager(this._db);
